...
const (
	UserCenter_CreateUser_FullMethodName = "/miniusercenter.v1.UserCenter/CreateUser"
)
...
func (c *userCenterClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedUserCenterServer) CreateUser(context.Context, *CreateUserRequest) (*emptypb.Empty, error) {
...
var UserCenter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "miniusercenter.v1.UserCenter",
	...
	Metadata: "miniusercenter/v1/miniusercenter.proto",
}
